...
static int GifIMax(int l, int r) {
	return l > r ? l : r;
}

static int GifIMin(int l, int r) {
	return l < r ? l : r;
}

static int GifIAbs(int i) {
	return i < 0 ? -i : i;
}
...
static bool GifBegin(GifWriter* writer, uint32_t width, uint32_t height, uint32_t delay) {
