/*
 * Copied from giflib because GifQuantizeBuffer is non-exported and shared library does not contain it
 */
...
GifQuantizeBuffer(unsigned int Width,
    ...
    unsigned int Index, NumOfEntries, i, j, NewColorMapSize;
    int MaxRGBError[3];
    long Red, Green, Blue;
...
SubdivColorMap(NewColorMapType * NewColorSubdiv,
	 ...
	 */
        ...
        Sum = (long)NewColorSubdiv[Index].Count / 2 - QuantizedColor->Count;
        NumEntries = 1;
